...
class CreateBetMatchParejasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bet_match_parejas', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->text('press_every')->nullable();
