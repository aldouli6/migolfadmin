...
class CreateBetMedalPlaysTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('bet_medal_plays', function (Blueprint $table) {
            $table->increments('id');
