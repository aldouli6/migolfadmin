...
class HoleController extends AppBaseController
{
    ...
    public function store(CreateHoleRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/holes.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($hole)) {
            Flash::error(__('messages.not_found', ['model' => __('models/holes.singular')]));
    ...
    public function update($id, UpdateHoleRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/holes.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/holes.singular')]));
